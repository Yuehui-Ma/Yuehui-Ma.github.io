...
<div class="cat-card">
  ...
  <img src="{{ 'assets/images/etc/cat4.jpg' | relative_url }}"
       class="cat-photo"
       alt="Rongrong">
  ...
  <div class="cat-caption">
    ...
    <h6>Rongrong</h6>
    <p>
      Always looking at the world with bright, curious eyes, as if every ordinary moment holds a new little adventure.
    </p>
  </div>
